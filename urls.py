...
urlpatterns = [
    ...
    path("articlecategorycreate/", views.ArticleCategoryCreateView.as_view(), name="articlecategory-create"),
    path("articlecategorypopup/", views.ArticleCategoryCreateView.as_view(), name="articlecategory-popup"),
