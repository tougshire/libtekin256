...
class ArticleStatus(models.Model):
    ...
    orderpos = models.IntegerField(
        "list position", default=0, help_text="The position for default sorting"
    )
    show = models.BooleanField(
        "show by default",
        default=True,
        help_text="If articles of this status should be shown by default",
    )
...
class Location(models.Model):
    full_name = models.CharField(
        "name", max_length=80, help_text="The full name of this location"
    )
    abbreviation = models.CharField(
        "abbreviation",
        max_length=10,
        blank=True,
        help_text="An abbreviation of the name",
    )
...
class MamodelCategory(models.Model):
    name = models.CharField(
        "name", max_length=80, help_text="The name of this category for make/models"
    )
    hide01 = models.BooleanField(
        "hide customfield01", default=False, help_text="Hide custom field 01"
    )
    hide02 = models.BooleanField(
        "hide customfield02", default=False, help_text="Hide custom field 02"
    )
    hide03 = models.BooleanField(
        "hide customfield03", default=False, help_text="Hide custom field 03"
    )
    hide04 = models.BooleanField(
        "hide customfield04", default=False, help_text="Hide custom field 04"
    )
    hide05 = models.BooleanField(
        "hide customfield05", default=False, help_text="Hide custom field 05"
    )
    hide06 = models.BooleanField(
        "hide customfield06", default=False, help_text="Hide custom field 06"
    )
    hide07 = models.BooleanField(
        "hide customfield07", default=False, help_text="Hide custom field 07"
    )
    hide08 = models.BooleanField(
        "hide customfield08", default=False, help_text="Hide custom field 08"
    )
    hide09 = models.BooleanField(
        "hide customfield09", default=False, help_text="Hide custom field 09"
    )
    hide10 = models.BooleanField(
        "hide customfield10", default=False, help_text="Hide custom field 10"
    )
    hide11 = models.BooleanField(
        "hide customfield11", default=False, help_text="Hide custom field 11"
    )
    hide12 = models.BooleanField(
        "hide customfield12", default=False, help_text="Hide custom field 12"
    )
    hide13 = models.BooleanField(
        "hide customfield13", default=False, help_text="Hide custom field 13"
    )
    hide14 = models.BooleanField(
        "hide customfield14", default=False, help_text="Hide custom field 14"
    )
    hide15 = models.BooleanField(
        "hide customfield15", default=False, help_text="Hide custom field 15"
    )
    hide16 = models.BooleanField(
        "hide customfield16", default=False, help_text="Hide custom field 16"
    )
...
class Mamodel(models.Model):
    ...
    inventory_index_twin = models.CharField(
        "Index field",
        choices=get_inventory_index_twin_choices,
        max_length=60,
        help_text="The article field to be mated with the inventory id.  Ex: If there is a Serial Number field and Serial Number is chosen, then this field and Serial Number will be kept identical",
    )
    category = models.ForeignKey(
        ...
        help_text="The category of this model",
    )
    brand = models.CharField(
        "Brand", blank=True, max_length=50, help_text="The brand name"
    )
    name = models.CharField(
        "Name", max_length=60, blank=True, help_text="The common name for the model"
    )
    number = models.CharField(
        "Model number",
        max_length=60,
        blank=True,
        help_text="The common name for the model",
    )
...
class Article(models.Model):
    ...
    mamodel = models.ForeignKey(
        Mamodel,
        verbose_name="model",
        null=True,
        on_delete=models.SET_NULL,
        help_text="The make and model of this article",
    )
    role = models.ForeignKey(
        ...
        blank=True,
        on_delete=models.SET_NULL,
        help_text="The role of this article",
    )
    status = models.ForeignKey(
        ArticleStatus,
        null=True,
        on_delete=models.SET_NULL,
        help_text="The status of this article",
    )
    statusdate = models.DateField(
        "status date",
        null=True,
        default=date.today,
        help_text="The date of the current status",
    )
    inventorydate = models.DateField(
        "inventory date",
        null=True,
        default=date.today,
        help_text="The date of the latest confirmation of possetion of this article",
    )
    home_location = models.ForeignKey(
        ...
        help_text="The home location of the article",
    )
    assignee = models.ForeignKey(
        ...
        help_text="The person or organization to whom this article is assigned for use",
    )
    responsible_party = models.ForeignKey(
        ...
        help_text="The person or organization responsible for the condition and availability of this article",
    )
    common_name = models.CharField(
        "common name",
        max_length=60,
        blank=True,
        help_text='The common name, ex:"Director\'s Laptop", "Meeting Room Projector"',
    )
...
class ArticleNoteSubject(models.Model):
    subject_line = models.CharField(
        "subject", max_length=63, help_text="The subject of the note"
    )
    last_used = models.DateTimeField(
        "date/time", default=timezone.now, help_text="The date of the most recent note"
    )
...
class ArticleNote(models.Model):
    ...
    when = models.DateField(
        "date",
        default=date.today,
        help_text="The date that the event occured or the action was taken if appliable, or the date that this note was made",
    )
    ...
    subject = models.ForeignKey(
        ...
        help_text="The standard subject of this note, if a standard subject is used",
        related_name="articlenotes",
    )
    description = models.TextField(
        "description/updates",
        max_length=255,
        blank=True,
        help_text="The description, if needed, and updates not including the resolution",
    )
    resolution = models.CharField(
        "resolution",
        max_length=255,
        blank=True,
        help_text="For problems - a description of the resolution",
    )
    is_pinned = models.BooleanField(
        "pinned",
        default=False,
        help_text="If this note is both current and important (unpin an problem when the problem is revolved) - for examples: if the article is under watch due to problems, has a special condition or feature, is on loan, etc..",
    )
    updated_at = models.DateTimeField(
        "updated_at",
        auto_now=True,
        help_text="The date this note was upated.  Used for sorting",
    )
...
class ArticleLink(models.Model):
    ...
    name = models.CharField(
        "Link Name", max_length=65, blank=True, help_text="The name of the link"
    )
...
class ArticleSnap(models.Model):
    ...
    inventory_index = models.CharField(
        "unique id",
        max_length=80,
        help_text="The unique ID to be used for this system. You'll likely want to use the manufacturer's serial number, your organization's inventory number, or bios number, IMEI, etc..",
    )
    mamodel = models.ForeignKey(
        Mamodel,
        verbose_name="model",
    ...
    statusdate = models.DateField(
        "status date", null=True, help_text="The date of the current status"
    )
    inventorydate = models.DateField(
        "status date", null=True, help_text="The date of the current status"
    )
    home_location = models.ForeignKey(
        ...
        blank=True,
        on_delete=models.SET_NULL,
        related_name="home_location_history",
        help_text="The article's home location",
    )
    assignee = models.ForeignKey(
        Entity,
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        related_name="assigned_item_history",
        help_text="The person or organization to whom this article is assigned for use",
    )
    responsible_party = models.ForeignKey(
        Entity,
        ...
        blank=True,
        on_delete=models.SET_NULL,
        related_name="responsible_for_history",
        help_text="The person or organization responsible for the condition and availability of this article",
    )
    common_name = models.CharField(
        "common name",
